...
contract e2m is ERC721Enumerable, Ownable {
    ...
    */
    ...
    function domainToHashKey(string calldata domainName) internal pure returns (uint256) {
    ...
    function mint(string calldata domainName) external payable returns (uint256) {
        ...
        require(msg.sender == ens.ownerOf(hashKey),  "You are not the owner of this ENS domain, please input the name without '.eth'.");
